...
/// Configuration for a aws_sdk_s3vectors service client.
///
...
impl Builder {
    ...
    /// use aws_sdk_s3vectors::config::Config;
    ...
    /// # fn example() {
    /// use std::time::Duration;
    /// use aws_sdk_s3vectors::config::{Builder, Config};
    /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
    ///
    ...
    /// }
    ///
    /// let mut builder = aws_sdk_s3vectors::Config::builder();
    ...
    /// impl aws_sdk_s3vectors::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a aws_sdk_s3vectors::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// }
    ///
    /// let config = aws_sdk_s3vectors::Config::builder()
    ...
    ///     // ...
    ///     .build();
    /// let client = aws_sdk_s3vectors::Client::from_conf(config);
    /// ```
    ...
    /// ```no_run
    /// use aws_sdk_s3vectors::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
    /// #[derive(Debug)]
    ...
    /// let config = aws_sdk_s3vectors::Config::builder().endpoint_resolver(resolver).build();
    /// let client = aws_sdk_s3vectors::Client::from_conf(config);
    /// ```
    pub fn endpoint_resolver(
        mut self,
    ...
    /// ```no_run
    /// use aws_sdk_s3vectors::config::Config;
    /// use aws_sdk_s3vectors::config::retry::RetryConfig;
    ///
    ...
    ///
    /// ```no_run
    /// use aws_sdk_s3vectors::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    ...
    ///
    /// ```no_run
    /// use aws_sdk_s3vectors::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    /// pub struct ForeverSleep;
    ///
    ...
    /// # use std::time::Duration;
    /// use aws_sdk_s3vectors::config::Config;
    /// use aws_sdk_s3vectors::config::timeout::TimeoutConfig;
    ///
    ...
    /// # Default Behavior
    ///
    /// When no retry partition is explicitly set, the SDK automatically creates a default retry partition named `s3vectors`
    /// (or `s3vectors-<region>` if a region is configured).
    /// All S3Vectors clients without an explicit retry partition will share this default partition.
    ///
    /// # Notes
    ///
    ...
    /// ```no_run
    /// use aws_sdk_s3vectors::config::Config;
    /// use aws_sdk_s3vectors::config::retry::{RetryPartition, TokenBucket};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_s3vectors::config::Config;
    /// use aws_sdk_s3vectors::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_s3vectors::config::IdentityCache;
    ///
    /// let config = aws_sdk_s3vectors::Config::builder()
    ...
    /// #    fn meta(&self) -> &aws_sdk_s3vectors::error::ErrorMetadata { todo!() }
    /// # }
    ///
    ...
    pub fn build(mut self) -> Config {
        ...
        layer.store_put(::aws_types::SigningName::from_static("s3vectors"));
        layer
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("aws_sdk_s3vectors::config::Config")
                .freeze(),
            cloneable: layer,
...
impl ServiceRuntimePlugin {
    pub fn new(_service_config: crate::config::Config) -> Self {
        let config = {
            let mut cfg = ::aws_smithy_types::config_bag::Layer::new("S3Vectors");
            cfg.store_put(
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_s3vectors::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
...
pub(crate) fn base_client_runtime_plugins(
    ...
    let default_retry_partition = "s3vectors";
